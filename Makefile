...
program_LIBRARY_DIRS := \
	...
	../mathutil/lib \
	../vfilesystem/lib \
	../luabind_09_for_lua_52x/luabind/lib
...
$(program_name): $(program_OBJS)
	...
	$(CXX) $(link_params) -o lib/lib$(lib_NAME).so $(program_OBJS) -Wl,-rpath ./lib -Wl,-rpath ./ $(foreach librarydir,$(program_LIBRARY_DIRS),-L$(librarydir)) $(foreach library,$(program_LIBRARIES),-l$(library))
else ifeq ($(build_type),1)
$(program_name): $(program_OBJS)
	ar crf lib/lib$(lib_NAME).a $(program_OBJS)
else
$(program_name): $(program_OBJS)
	$(CXX) -o $(out_dir)/$(program_name).out $(build_params) $(program_OBJS) -ldl -Wl,-rpath=$ORIGIN/lib
endif
